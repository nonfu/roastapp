    ...
    actions: {
        ...
        */
        addAdminCity({
            ...
            */
            CitiesAPI.postAddCity(data.name, data.state, data.country, data.latitude, data.longitude)
                .then(function (response) {
        ...
        */
        updateAdminCity({
            ...
            */
            CitiesAPI.putUpdateCity(data.id, data.name, data.state, data.country, data.latitude, data.longitude)
                .then(function (response) {
